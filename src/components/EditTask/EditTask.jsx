        ...
        <>
            ...
            {isFormOpen && (
                <form
                    ...
                    className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-70 z-50 flex justify-center items-center"
                >
                    <div className="bg-white absolute top-10 flex justify-between rounded-2xl p-8 w-3/4 h-[90%]">
                        <div className="w-[60%]">
                            ...
                            <div className="flex justify-between items-center mt-20">
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex">
                                        <button
                                            ...
                                            className={`${taskDetails.TaskCat === 'Work'
                                        ...
                                        <button
                                            ...
                                            className={`${taskDetails.TaskCat === 'Personal'
                                                ? 'bg-[#7b1984] text-white'
                                                : 'bg-gray-50 text-gray-900'
                                                } border border-gray-300 text-sm px-3 py-2 rounded-full w-20 h-[40px] text-center`}
                                        >
                                ...
                                <div className="relative">
                                    ...
                                    {isOpen && (
                                        <div
                                            ref={divRef}
                                            className="absolute bg-[#FFF9F9] border p-3 bottom-22 right-10 border-[#7B198426] rounded-lg w-40 mt-2"
                                        >
                        ...
                        <div className='flex flex-col justify-between w-[40%] items-start'>
